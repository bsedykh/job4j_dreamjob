...
public class VacancyControllerTest {
    ...
    @Test
    public void whenGetVacancyByIdThenGetPageWithVacancyAndCities() {
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        when(cityService.findAll()).thenReturn(expectedCities);
        var expectedVacancy = new Vacancy(1, "test1", "desc1", now(),
                true, 1, 2);
    ...
    @Test
    public void whenCannotGetVacancyByIdThenGetErrorPageWithMessage() {
    ...
    @Test
    public void whenCannotUpdateVacancyThenGetErrorPageWithMessage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
    ...
    @Test
    public void whenCannotDeleteVacancyThenGetErrorPageWithMessage() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
