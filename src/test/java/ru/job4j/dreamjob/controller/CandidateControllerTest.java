...
class CandidateControllerTest {
    ...
    @Test
    public void whenGetCandidateByIdThenGetPageWithCandidateAndCities() {
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
        when(cityService.findAll()).thenReturn(expectedCities);
    ...
    @Test
    public void whenCannotGetCandidateByIdThenGetErrorPageWithMessage() {
    ...
    @Test
    public void whenCannotUpdateCandidateThenGetErrorPageWithMessage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var expectedMessage = "Кандидат с указанным идентификатором не найден";
    ...
    @Test
    public void whenCannotDeleteCandidateThenGetErrorPageWithMessage() {
        var expectedMessage = "Кандидат с указанным идентификатором не найден";
